  ...
  return (
    <header className="bg-slate-900 text-white border-b border-slate-800 px-6 py-3 flex items-center justify-between shadow-md">
      ...
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h1 className="font-bold text-lg tracking-tight text-white flex items-center gap-2">
            ...
            <span className="bg-blue-900/60 text-blue-300 text-xs font-medium px-2 py-0.5 rounded border border-blue-700/50">
      ...
      <div className="flex items-center space-x-4">
        {/* TOTP Status */}
        {isTotpVerified ? (
          <div className="flex items-center text-xs text-emerald-400 bg-emerald-950/60 border border-emerald-800 px-2.5 py-1 rounded-full space-x-1">
            <ShieldCheck className="w-3.5 h-3.5" />
            <span>TOTP 2FA Verified</span>
          </div>
        ) : (
          <div className="flex items-center text-xs text-amber-400 bg-amber-950/60 border border-amber-800 px-2.5 py-1 rounded-full space-x-1">
        ...
        <div className="flex items-center space-x-2 bg-slate-800 border border-slate-700 px-3 py-1.5 rounded-lg">
          ...
          <select
            ...
            className="bg-slate-900 text-white text-xs font-semibold rounded px-2 py-1 border border-slate-700 focus:outline-none focus:ring-1 focus:ring-blue-500"
          >
            {users.map(u => (
